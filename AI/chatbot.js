...
module.exports.chatbot = async (question, content, summary) => {
  ...
  const messages = [
    {
      role: 'system',
      content: `You are a helpful study assistant. Answer questions about the material based on the provided content and summary. Be concise, accurate, and helpful for students.Do not return in markdonw or list. Just plain text`
    },
    {
      role: 'user',
